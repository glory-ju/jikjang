...
class InvalidArgs(Exception):
    ...
    def __str__(self):
        return str(self.args) + str(self.message)
...
class InvalidCategory(Exception):
    ...
    def __str__(self):
        return str(self.category) + str(self.message)
...
class OverbalanceMonth(Exception):
    def __init__(self, start_month, end_month):
        ...
        self.message = "start_month(" + str(self.start_month) + ") is an overbalance with end_month" \
                       + "(" + str(self.end_month) + ")"
